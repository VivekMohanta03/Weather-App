...
url = "https://weather.com/en-IN/weather/today/l/68509ddcc58030eeb09cd5130641916746139e9174ab3527650e99b108d95ed9"

master = Tk()
master.title("Weather App")
master.config(bg = "white")

img = Image.open("G:\Weather App\weather.png")
...
temperatureLabel.grid(row=0,sticky="W",padx=20,pady=50)
Label(master,image=img,bg="white").grid(row=0,sticky="E")

weatherPredictionLabel = Label(master,font=("Calibri bold",25),bg="white")
weatherPredictionLabel.grid(row=1,sticky="W",padx=20)
